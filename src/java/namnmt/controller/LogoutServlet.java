...
public class LogoutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cookies != null) {
                //2. if cookies have existed, get the newest cookie
                ...
                //5. process result
                if (result !=null) {
                    newestCookie.setMaxAge(0);
                    response.addCookie(newestCookie);
                    url = LOGIN_PAGE;
                }//end user is unthenticated
            }//cookies had existed
        
        } catch (SQLException ex) {
            log("LogoutServlet _ SQL: " + ex.getMessage());
        } catch (ClassNotFoundException ex) {
           log("LogoutServlet _ ClassNotFoundException: " + ex.getMessage());
        } finally {
